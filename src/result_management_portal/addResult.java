...
public class addResult extends javax.swing.JFrame {
          ...
          String ec=jTextField4.getText();
           String dbms=jTextField5.getText();
            ...
            try{
                       ...
                       if(rs.next()){
                           st.executeUpdate("insert into result(rollno,physics,maths,em,dbms,os)values('"+roll+"','"+phy+"',"+math+",'"+ec+"','"+dbms+"','"+os+"')");
                           JOptionPane.showMessageDialog(null,"Marks saved successfully");
                           setVisible(false);
                           new addResult().setVisible(true);
                       }
                       else{
                           JOptionPane.showMessageDialog(null,"This rollno is registered!");
                       }
    ...
    /**
     * @param args the command line argumentsOp
     */
