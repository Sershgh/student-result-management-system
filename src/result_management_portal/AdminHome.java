...
public class AdminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ME", "CSE", "EE", "ECE", "IT" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/srms","root","HP#456");
            Statement st=con.createStatement();
            st.executeUpdate("insert into student(rollno,course,branchname,name,gender,guardianname)values('"+rollnumber+"','"+course+"','"+branchName+"','"+Name+"','"+gender+"','"+guardianname+"')");
